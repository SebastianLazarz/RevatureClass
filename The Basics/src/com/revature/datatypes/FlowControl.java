...
public class FlowControl {
	...
	public void flowControl() {
		...
		if (myBoolean) {
			...
			// This is the "catch-all" block of code that runs of no other block runs
		}
		...
		String[] names = { "Jacob",  "Daniel", "Allison" }; // This is called array initialization and allows us to create an array and populate it with data
